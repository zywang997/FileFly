...
from .. import db, csrf
from ..models import FileTable, ShareTable, RecycleTable, UserTable
    ...
    if request.method == 'POST':
        ...
        if file:
            ...
            try:
                ...
                userobj = UserTable.query.filter_by(user_id=user_id).first_or_404()
                userobj.credits += 5
...
@file.route('/sid/<int:id>', methods=['GET', 'POST'])
@login_required
def share_detail(id):
    fileobj = FileTable.query.filter_by(file_id=id, is_recycle=False).first_or_404()
